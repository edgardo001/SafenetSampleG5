...
CK_RV CK_ENTRY CA_CreateContainerWithPolicy(CK_SESSION_HANDLE hSession,
                                    ...
                                    CK_ULONG_PTR pulContainerNumber,
                                    CK_BYTE_PTR  pPolicyDefaults,
                                    CK_BYTE_PTR  pPolicyDestructiveOn,
                                    CK_BYTE_PTR  pPolicyDefstructiveOff);
...
CK_RV CK_ENTRY CA_LKMInitiatorChallenge(
                     ...
                     CK_ULONG_PTR            pulChallengeBufSize ); // Max. size of challenge buffer & returned size
...
CK_RV CK_ENTRY CA_LKMReceiverResponse(
                     ...
                     CK_ULONG_PTR            pulResponseBufSize ); // Max. size of response buffer & returned size
...
CK_RV CK_ENTRY CA_LKMInitiatorComplete(
                     ...
                     CK_ULONG_PTR            pulCompleteBufSize, // Max. size of challenge buffer & returned size
