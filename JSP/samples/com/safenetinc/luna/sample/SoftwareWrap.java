...
/**
 * This sample demonstrates wrapping a software key. This demo assumes that
 * the Luna providers are not listed first in the java.security file and that
 * a software provider is the default This could be SUN / IBM / BC / ...
 */
public class SoftwareWrap {
    ...
    public static void main(String args[]) {
            ...
            if ((cause != null) && (cause instanceof LunaCryptokiException)) {
                ...
                if (lcex.GetCKRValue() == 0x69) {
                    System.out.println("The private RSA key was created with the Luna provider,"
                            ...
                            + " crypto provider that supports RSA to have precedence over the"
                            + " Luna provider in java.security");
                    System.exit(1);
                }
            }
            ...
            if ((cause != null) && (cause instanceof LunaCryptokiException)) {
                ...
                if (lcex.GetCKRValue() == 0x6A) {
                    System.out.println("The AES key was created with the Luna provider, and cannot"
                        ...
                        + " provider that supports AES to have precedence over the Luna provider"
                        + " in java.security");
                    System.exit(1);
                }
            }
        ...
        try {
            ...
            myUnwrapper.init(Cipher.UNWRAP_MODE, hwAESKey, mAlgParams);
            unwrappedAESKey = (SecretKey) myUnwrapper.unwrap(wrappedAESKey,
