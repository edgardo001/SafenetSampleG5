 ...
 * <p>
 * WARNING: In general, all access to HSM objects should be through the JCA/JCE
 * API.  Accessing and modifying LunaTokenObjects directly can have unintended
 * consequences; the code below is for illustration only.
 */
public class ObjectMod {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            byte[] newId = { 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
            ...
            System.out.println("Large Attribute Test:\n\tOld value: "
                    + LunaUtils.getHexString(id, true) + "\n\tNew Value: "
                    + LunaUtils.getHexString(id2, true) + "\nTried to set it as: "
                    + LunaUtils.getHexString(newId, true) + "\n");
